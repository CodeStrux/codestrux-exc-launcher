<p align="center">
  <img src="assets/logos/exc-icon-dark-256.png" alt="exc logo" width="120">
</p>

# exc - the everything menu for your terminal
...
small generic starter, never this one. For more commands to add on top of
it, see [Examples](#examples) below.
...
[`EXAMPLES.md`](EXAMPLES.md) is a categorized cookbook of ready-to-paste
`[[profiles.commands]]` entries — system tools, Docker, software
development, networking, Kubernetes/cloud, databases, and security/crypto —
for filling out your own config beyond the starter set.
